    ...
    scene.add_entity(
        ...
        surface=gs.surfaces.Plastic(
            ...
            normal_texture=gs.textures.ImageTexture(
                image_path=f"37700076-69ae-4cbd-b2b6-d79cd538d818/concrete_56_normal-2K.png", encoding="linear"
            ),
            roughness_texture=gs.textures.ImageTexture(
                image_path=f"37700076-69ae-4cbd-b2b6-d79cd538d818/concrete_56_roughness-2K.jpg", encoding="linear"
            ),
            double_sided=True,
        ),
    )
